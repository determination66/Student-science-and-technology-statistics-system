...
void Dialog::on_pushButton_clicked()
{
    ...
    }else if(ui->radioButton_3->isChecked())
    {
        ...
        if(flag)
        {
            QString d="D:\\qtproject\\untitled1\\infotxt\\未审核内容\\未审核科研训练.txt",nn="科研训练";
            QFile f(d);
            f.open(QIODevice::Append | QIODevice::Text);
    ...
    }else if(ui->radioButton_4->isChecked())
    {
        ...
        if(flag)
        {
            QString d="D:\\qtproject\\untitled1\\infotxt\\未审核内容\\未审核学科与科技竞赛.txt",nn="学科与科技竞赛";
            QFile f(d);
            f.open(QIODevice::Append | QIODevice::Text);
    ...
    }else if(ui->radioButton_5->isChecked())
    {
        ...
        if(flag)
        {
            QString d="D:\\qtproject\\untitled1\\infotxt\\未审核内容\\未审核技能证书.txt",nn="技能证书";
            QFile f(d);
            f.open(QIODevice::Append | QIODevice::Text);
            f.write(nn.toUtf8()+' '+name.toUtf8()+' '+student_num.toUtf8()+' '+student_lel.toUtf8()+' ');
    ...
    }else if(ui->radioButton_6->isChecked())
    {
        ...
        if(flag)
        {
            QString d="D:\\qtproject\\untitled1\\infotxt\\未审核内容\\未审核创业实践和创新创业教育.txt",nn="创业实践和创新创业教育";
            QFile f(d);
            f.open(QIODevice::Append | QIODevice::Text);
            f.write(nn.toUtf8()+' '+name.toUtf8()+' '+student_num.toUtf8()+' '+student_lel.toUtf8()+' ');
